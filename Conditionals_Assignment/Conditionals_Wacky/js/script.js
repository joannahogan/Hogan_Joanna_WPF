...
if (playerOne === "rock" && playerTwo === "scissors"){
    ...
    console.log("Paper covers Rock!");
}else if (playerTwo === "rock" && playerOne === "lizard") {
    console.log("Rock crushes Lizard!");
}else if (playerTwo === "lizard" && playerOne === "spock") {
    console.log("Lizard poisons Spock!");
}else if (playerTwo === "spock" && playerOne === "scissors") {
    console.log("Spock smashes Scissors!");
}else if (playerTwo === "scissors" && playerOne === "lizard") {
    console.log("Scissors decapitates Lizard!");
}else if (playerTwo === "lizard" && playerOne === "paper") {
    console.log("Lizard eats Paper!");
}else if (playerTwo === "paper" && playerOne === "spock") {
    console.log("Paper disproves Spock!");
}else if (playerTwo === "spock" && playerOne === "rock") {
    console.log("Spock vaporizes Rock!");
}
